    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (file) {
                ...
                const uploadResponse = await axios.post("http://192.168.50.90:8080/theater/uploadImage", formData, {
            ...
            const response = await axios.post("http://192.168.50.90:8080/theater/addTheater", {
                ...eventData,
